...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(RegisterActivity.this, "Please enter your Phone Number first without country code..", Toast.LENGTH_SHORT).show();
                }
                ...
                {
                    Toast.makeText(RegisterActivity.this, "Please enter correct without country code..", Toast.LENGTH_SHORT).show();
                }
    ...
    private void CreateAccount(EditText phone, EditText name, EditText password) {
        ...
        details.put("Phone","+94"+phone.getText().toString());
        details.put("Name",name.getText().toString());
        details.put("Password",password.getText().toString());
        details.put("Vote","0");
        details.put("Party","");
        details.put("ID","");
        mref.child("Users").child("+94"+phone.getText().toString()).updateChildren(details)
